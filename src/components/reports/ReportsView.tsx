...
interface ReportData {
  ...
  workedHoursDetails?: WorkedHoursDetails;    // Detalles de superposiciones
  overlapsFound?: Array<{
    entry_id: number;
    schedule_id: number;
    user: string;
    ...
    for (const overlap of overlapsFound) {
      ...
      try {
        ...
        if (periodStart.includes('-') && periodStart.includes(' ')) {
          ...
          const entry = reportData.entries.find((e) => e.id === overlap.entry_id);
          if (entry) {
      ...
      <div className="charts-grid">
        ...
        <div className="chart-container chart-container--distribution" style={{ 
          ...
          <div className="chart-header">
            ...
            <div style={{ 
              ...
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  ...
                  <Tooltip 
                    formatter={(value: number, _name: string, props: { payload?: { entries?: number; active?: number } }) => {
            ...
            <div style={{ 
              flex: '1',
              minWidth: '280px',  // ✅ Ancho mínimo reducido
